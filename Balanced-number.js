/*
A balanced number is a number where the 
sum of digits to the left of the middle digit(s) 
...
The middle digit(s) should not be considered when 
determining whether a number is balanced or not, e.g. 
413023 is a balanced number because the left sum and right sum are both 5.

Task:
  Given a number, find if it is balanced, 
  and return the string "Balanced" or "Not Balanced" accordingly. 
